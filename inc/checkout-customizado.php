...
// function magnifico_custom_checkout($fields) {
...
//   return $fields;
// }
// add_filter('woocommerce_checkout_fields', 'magnifico_custom_checkout');
...
// // Adiciona Campo
// function magnifico_custom_checkout_field($checkout) {
...
// }
// add_action('woocommerce_after_order_notes', 'magnifico_custom_checkout_field');

// // Validar Campo
// function magnifico_custom_checkout_field_process() {
//   if(!$_POST['mensagem_personalizada']) {
//     wc_add_notice('Por favor, escreva uma mensagem personalizada.', 'error');
//   }
// }
// add_action('woocommerce_checkout_process', 'magnifico_custom_checkout_field_process');

// // Adicionar ao Banco de Dados
// function magnifico_custom_checkout_field_update($order_id) {
...
//   }
// }
// add_action('woocommerce_checkout_update_order_meta', 'magnifico_custom_checkout_field_update');
